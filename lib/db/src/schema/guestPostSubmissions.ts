...
export const guestPostSubmissionsTable = pgTable(
  ...
  (t) => [
    index("guest_post_submissions_status_idx").on(t.status),
    index("guest_post_submissions_created_at_idx").on(t.createdAt),
  ],
);
